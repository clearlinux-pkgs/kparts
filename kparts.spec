...
Version  : 6.3.0
Release  : 76
URL      : https://download.kde.org/stable/frameworks/6.3/kparts-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/kparts-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kparts-6.3.0.tar.xz.sig
...
%setup -q -n kparts-6.3.0
cd %{_builddir}/kparts-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717794384
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Parts.so.6.3.0
/usr/lib64/libKF6Parts.so.6
/usr/lib64/libKF6Parts.so.6.3.0
