...
Source0  : https://download.kde.org/stable/frameworks/6.1/kparts-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kparts-6.1.0.tar.xz.sig
...
%setup -q -n kparts-6.1.0
cd %{_builddir}/kparts-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713032955
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Parts.so.6.1.0
/usr/lib64/libKF6Parts.so.6
/usr/lib64/libKF6Parts.so.6.1.0
