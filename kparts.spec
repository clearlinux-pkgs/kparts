...
Version  : 5.103.0
Release  : 56
URL      : https://download.kde.org/stable/frameworks/5.103/kparts-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/kparts-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kparts-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kparts-5.103.0
cd %{_builddir}/kparts-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676853104
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Parts.so.5.103.0
