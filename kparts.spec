...
Version  : 5.113.0
Release  : 67
URL      : https://download.kde.org/stable/frameworks/5.113/kparts-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/kparts-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kparts-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kparts-5.113.0
cd %{_builddir}/kparts-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703012947
mkdir -p clr-build
pushd clr-build
