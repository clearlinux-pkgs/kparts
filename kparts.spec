...
Version  : 5.114.0
Release  : 68
URL      : https://download.kde.org/stable/frameworks/5.114/kparts-5.114.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.114/kparts-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kparts-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kparts-5.114.0
cd %{_builddir}/kparts-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705500049
mkdir -p clr-build
pushd clr-build
