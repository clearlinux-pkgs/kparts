...
Source0  : https://download.kde.org/stable/frameworks/5.115/kparts-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/kparts-5.115.0.tar.xz.sig
...
%prep
%setup -q -n kparts-5.115.0
cd %{_builddir}/kparts-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707760606
mkdir -p clr-build
pushd clr-build
