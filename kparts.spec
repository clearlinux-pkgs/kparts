...
Version  : 5.110.0
Release  : 64
URL      : https://download.kde.org/stable/frameworks/5.110/kparts-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kparts-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kparts-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kparts-5.110.0
cd %{_builddir}/kparts-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694459283
mkdir -p clr-build
pushd clr-build
